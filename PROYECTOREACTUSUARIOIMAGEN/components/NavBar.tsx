...
const navItems = [
    ...
    { text: 'Agregar Usuario', path: '/AgregarUsuario', icon: <CreateIcon sx={{ color: '#fff' }} /> },
    { text: 'Subir Producto', path: '/AgregarProductoMasivo', icon: <CreateIcon sx={{ color: '#fff' }} /> },
]
        ...
        <Box sx={{ flexGrow: 1 }}>
            <AppBar sx={{ width: '100%', backgroundColor: '#1e1e1e' }}>
                <Toolbar>
                    ...
                    <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}>Usuarios</Typography>
